    ...
    <body>
        ...
        <section id="featured" class="my-5 pb-5">
            ...
            <div class="row mx-auto container-fluid">
                ...
                <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                    <img class="img-fluid mb-3" src="assets/img/<?php echo $row['image']; ?>"/>
                    <div class="star">
        ...
        <section id="featured" class="my-5">
            ...
            <div class="row mx-auto container-fluid">
                <!-- Product 1 -->
                <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                    <img class="img-fluid mb-3" src="assets/img/dell1.jpg" />
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <!-- Product 2-->
                <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                    <img class="img-fluid mb-3" src="assets/img/dell2.jpg" />
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <!-- Product 3 -->
                <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                    <img class="img-fluid mb-3" src="assets/img/dell3.jpg" />
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <!-- Product 4 -->
                <div class="product text-center col-lg-3 col-md-4 col-sm-12">
                    <img class="img-fluid mb-3" src="assets/img/dell4.jpg" />
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="row container mx-auto pt-5">
                ...
                <div class="copyright mt-5">
                    <div class="row container mx-auto">
                        ...
                        <div
                            class="col-lg-3 col-md-5 col-sm-12 mb-4 text-nowrap mb-2"
                        >
        ...
        <!-- <Script> -->
        <script
            src="https://kit.fontawesome.com/5d5834f6a4.js"
            crossorigin="anonymous"
        ></script>
        <script
